...
{
    int argc = 0;
    cocos2d::gui::UICCLabelAtlas* cobj = NULL;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
...
#endif
    cobj = (cocos2d::gui::UICCLabelAtlas*)tolua_tousertype(tolua_S,1,0);
#if COCOS2D_DEBUG >= 1
    if (!cobj)
    {
...
int lua_cocos2dx_studio_UICCLabelAtlas_create(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        if(!ok)
            return 0;
        cocos2d::gui::UICCLabelAtlas* ret = cocos2d::gui::UICCLabelAtlas::create();
        do {
			if (NULL != ret){
				...
				cocos2d::Object *dynObject = dynamic_cast<cocos2d::Object *>((cocos2d::gui::UICCLabelAtlas*)ret);
				if (NULL != dynObject) {
...
{
    int argc = 0;
    cocos2d::gui::UICCLabelAtlas* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
            return 0;
        cobj = new cocos2d::gui::UICCLabelAtlas();
...
int lua_register_cocos2dx_studio_UICCLabelAtlas(lua_State* tolua_S)
{
    ...
    std::string typeName = typeid(cocos2d::gui::UICCLabelAtlas).name();
...
{
    int argc = 0;
    cocos2d::gui::UICCTextField* cobj = nullptr;
    bool ok  = true;
    ...
    cobj = (cocos2d::gui::UICCTextField*)tolua_tousertype(tolua_S,1,0);
...
int lua_cocos2dx_studio_UICCTextField_create(lua_State* tolua_S)
{
    ...
    if (argc == 3)
    {
        ...
        if(!ok)
            return 0;
        cocos2d::gui::UICCTextField* ret = cocos2d::gui::UICCTextField::create(arg0, arg1, arg2);
        do {
			if (NULL != ret){
				std::string hashName = typeid(*ret).name();
				auto iter = g_luaType.find(hashName);
				...
				cocos2d::Object *dynObject = dynamic_cast<cocos2d::Object *>((cocos2d::gui::UICCTextField*)ret);
				if (NULL != dynObject) {
					int ID = ret ? (int)(dynObject->_ID) : -1;
					int* luaID = ret ? &(dynObject->_luaID) : NULL;
					toluafix_pushusertype_ccobject(tolua_S,ID, luaID, (void*)ret,className.c_str());
...
int lua_cocos2dx_studio_UICCTextField_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
            return 0;
        cobj = new cocos2d::gui::UICCTextField();
        cocos2d::Object* dynObject = dynamic_cast<cocos2d::Object *>(cobj);
        if (nullptr != dynObject) 
        {
            dynObject->autorelease();
...
int lua_register_cocos2dx_studio_UICCTextField(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::gui::UICCTextField).name();
...
int lua_register_cocos2dx_studio_UIHelper(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::gui::UIHelper).name();
