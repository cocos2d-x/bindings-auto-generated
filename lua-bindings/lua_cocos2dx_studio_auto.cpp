...
int lua_register_cocos2dx_studio_UILayoutParameter(lua_State* tolua_S)
{
    ...
    std::string typeName = typeid(gui::UILayoutParameter).name();
    g_luaType[typeName] = "UILayoutParameter";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILinearLayoutParameter(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILinearLayoutParameter).name();
    g_luaType[typeName] = "UILinearLayoutParameter";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIRelativeLayoutParameter(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIRelativeLayoutParameter).name();
    g_luaType[typeName] = "UIRelativeLayoutParameter";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIWidget(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIWidget).name();
    g_luaType[typeName] = "UIWidget";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILayout(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILayout).name();
    g_luaType[typeName] = "UILayout";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIRootWidget(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIRootWidget).name();
    g_luaType[typeName] = "UIRootWidget";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIButton(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIButton).name();
    g_luaType[typeName] = "UIButton";
    return 1;
}
...
int lua_register_cocos2dx_studio_UICheckBox(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UICheckBox).name();
    g_luaType[typeName] = "UICheckBox";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIImageView(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIImageView).name();
    g_luaType[typeName] = "UIImageView";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILabel(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILabel).name();
    g_luaType[typeName] = "UILabel";
    return 1;
}
...
int lua_register_cocos2dx_studio_UICCLabelAtlas(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UICCLabelAtlas).name();
    g_luaType[typeName] = "UICCLabelAtlas";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILabelAtlas(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILabelAtlas).name();
    g_luaType[typeName] = "UILabelAtlas";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILoadingBar(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILoadingBar).name();
    g_luaType[typeName] = "UILoadingBar";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIScrollView(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIScrollView).name();
    g_luaType[typeName] = "UIScrollView";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIListView(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIListView).name();
    g_luaType[typeName] = "UIListView";
    return 1;
}
...
int lua_register_cocos2dx_studio_UISlider(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UISlider).name();
    g_luaType[typeName] = "UISlider";
    return 1;
}
...
int lua_register_cocos2dx_studio_UICCTextField(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UICCTextField).name();
    g_luaType[typeName] = "UICCTextField";
    return 1;
}
...
int lua_register_cocos2dx_studio_UITextField(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UITextField).name();
    g_luaType[typeName] = "UITextField";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILabelBMFont(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILabelBMFont).name();
    g_luaType[typeName] = "UILabelBMFont";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIPageView(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIPageView).name();
    g_luaType[typeName] = "UIPageView";
    return 1;
}
...
int lua_register_cocos2dx_studio_UIHelper(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UIHelper).name();
    g_luaType[typeName] = "UIHelper";
    return 1;
}
...
int lua_register_cocos2dx_studio_UILayer(lua_State* tolua_S)
{
    ...
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(gui::UILayer).name();
    g_luaType[typeName] = "UILayer";
    return 1;
}
...
int lua_cocos2dx_studio_Armature_setAnchorPoint(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::Armature* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_Armature_setAnchorPoint'", NULL);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_Armature_setAnchorPoint'.",&tolua_err);
#endif
    return 0;
}
...
int lua_cocos2dx_studio_Armature_getAnchorPointInPoints(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::Armature* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_Armature_getAnchorPointInPoints'", NULL);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_Armature_getAnchorPointInPoints'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_studio_Armature(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Armature");
        ...
        tolua_function(tolua_S,"setAnchorPoint",lua_cocos2dx_studio_Armature_setAnchorPoint);
        ...
        tolua_function(tolua_S,"getAnchorPointInPoints",lua_cocos2dx_studio_Armature_getAnchorPointInPoints);
